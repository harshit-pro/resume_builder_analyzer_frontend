...
import { useAuth as useCustomAuth } from '../context/AuthContext.jsx'; // renamed to avoid clash
...
const Pricing = () => {
  ...
  const { loadUserCredits } = useCustomAuth();
      ...
      <div className="container mx-auto px-4 ">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative pt-6 p-6 ${plan.popular
